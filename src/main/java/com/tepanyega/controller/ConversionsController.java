package com.tepanyega.controller;



import Datatransferobject.Distance;
import Datatransferobject.Temperature;
...
public class ConversionsController {
    ...
    public Temperature kelvinToCelsius(@PathVariable(value = "temperatureInKelvin") String temperatureInKelvin) {
    ...
    public Temperature celsiusToKelvin(@PathVariable(value = "temperatureInCelsius") String temperatureInCelsius) {
        long startTime = System.currentTimeMillis();
    ...
    public Distance milesToKilometers(@PathVariable(value = "distanceInMiles") String distanceInMiles) {
        long startTime = System.currentTimeMillis();
    ...
    public Distance kilometersToMiles(@PathVariable(value = "distanceInKilometers") String distanceInKilometers) {
        long startTime = System.currentTimeMillis();
